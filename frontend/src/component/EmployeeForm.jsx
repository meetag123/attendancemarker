...
import { employeeForm } from '../slice/EmployeeSlice';
...
const EmployeeForm = ({ onAdd }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     const res= await dispatch(employeeForm({name,email,phone})).unwrap();
      if (onAdd) onAdd(res.user);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8 bg-gradient-to-bray from-cream to-teal-500 font-poppins">
      {/* Header */}
      <header className="flex items-center mb-6 space-x-2">
        <UserIcon className="w-8 h-8 text-coral-500" />
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full p-3 text-gray-700 transition-colors border-none rounded-lg shadow-sm bg-teal-50 focus:outline-none focus:ring-2 focus:ring-coral-400"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full p-3 text-gray-700 transition-colors border-none rounded-lg shadow-sm bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400"
          ...
          <div className="relative">
            ...
            >
              ...
              {!isSubmitting && (
                <span className="absolute inset-0 hidden bg-white rounded-lg opacity-0 animate-ripple group-hover:block"></span>
              )}
            </button>
          </div>
        </div>
